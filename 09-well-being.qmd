...
- **2022**: delete first column 'RANK', as I will create column `rank` myself
...
save_data_file("whr", WHR_data_2022_raw, "WHR_data_2022_raw.rds")
...
save_data_file("whr", WHR_data_2021_raw, "WHR_data_2021_raw.rds")
...
save_data_file("whr", WHR_data_2020_raw, "WHR_data_2020_raw.rds")
...
save_data_file("whr", WHR_data_2015_raw, "WHR_data_2015_raw.rds")
...
save_data_file("whr", WHR_data_2013_raw, "WHR_data_2013_raw.rds")
...
create_folder(base::paste0(here::here(), "/data/whr/ladder"))
...
save_data_file("whr/ladder", ladder_2024, "WHR_ladder_2024.rds")

ladder_2023 <- create_ladder_table(2023)
save_data_file("whr/ladder", ladder_2023, "WHR_ladder_2023.rds")

ladder_2022 <- create_ladder_table(2022)
save_data_file("whr/ladder", ladder_2022, "WHR_ladder_2022.rds")

ladder_2021 <- create_ladder_table(2021)
save_data_file("whr/ladder", ladder_2021, "WHR_ladder_2021.rds")

ladder_2020 <- create_ladder_table(2020)
save_data_file("whr/ladder", ladder_2020, "WHR_ladder_2020.rds")

ladder_2019 <- create_ladder_table(2019)
save_data_file("whr/ladder", ladder_2019, "WHR_ladder_2019.rds")

ladder_2018 <- create_ladder_table(2018)
save_data_file("whr/ladder", ladder_2018, "WHR_ladder_2018.rds")

ladder_2017 <- create_ladder_table(2017)
save_data_file("whr/ladder", ladder_2017, "WHR_ladder_2017.rds")

ladder_2016 <- create_ladder_table(2016)
save_data_file("whr/ladder", ladder_2016, "WHR_ladder_2016.rds")

ladder_2015 <- create_ladder_table(2015)
save_data_file("whr/ladder", ladder_2015, "WHR_ladder_2015.rds")

ladder_2013 <- create_ladder_table(2013)
save_data_file("whr/ladder", ladder_2013, "WHR_ladder_2013.rds")

ladder_2012 <- create_ladder_table(2012)
save_data_file("whr/ladder", ladder_2012, "WHR_ladder_2012.rds")


whr_join <- dplyr::full_join(ladder_2024, ladder_2023, by = "country") |> 
