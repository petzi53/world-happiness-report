...
[^01-data-resources-1]: But the WIID in is latest version is also
    ...
    [WIID](https://www.wider.unu.edu/database/world-income-inequality-database-wiid). Additionally there are concerns about the data imputation model at least for versio 4.0.
