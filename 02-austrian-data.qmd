...
5.  Decompress the ZIP file with the appropriate tool on your computer.
    ...
    ".zip".
6.  Delete the ".zip" file.
7.  Add the path of the huge `wid_all_data` folder (2.38 GB) to `.gitignore` because you don't want to store all these files in your GitHub repo. Whenever you need a file to work on copy it programmatically in those areas that will be saved with Git.
:::
:::
