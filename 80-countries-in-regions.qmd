...
:::::{.my-r-code}
:::{.my-r-code-header}
:::::: {#cnj-download-country-codes-core}
...
country_codes <- readRDS("data/chap80/country_codes.rds")
...
Summarize data and show the number of countries in each of the eight regions used in WIR2022.
:::
...
:::{.my-r-code-header}
:::::: {#cnj-latin-america}
: Countries of the Latoin America region used in the WIR2022
::::::
:::
::::{.my-r-code-container}
```{r}
