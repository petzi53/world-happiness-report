...
:::::
:::::: {#exm-81-country-codes-variables}
::::::
...
:::::{.my-r-code}
:::{.my-r-code-header}
:::::: {#cnj-81-countries-without-subregions}
: Number of Records (=Variables) per Country without Subregions
::::::
:::
::::{.my-r-code-container}
```{r}
#| label: tab-81-variable-list-without-subregions
